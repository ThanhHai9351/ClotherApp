...
public class Register extends AppCompatActivity {
    ...
    private JSONObject submit() {
        ...
        try {
            ...
            Toast.makeText(this, "Loi tao json", Toast.LENGTH_SHORT).show();
        }
        return json;
    }

    private void them(JSONObject jsonObject) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, urlRegister, jsonObject, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Register.this, "That bai: " + error.toString(), Toast.LENGTH_SHORT).show();
            }
        });
